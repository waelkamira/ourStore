    ...
    <div className='mb-14'>
        <div className='flex justify-between mb-8'>
            <div>
                ...
                <h5 className='text-base font-[400]'>تسوق احدث المنتجات المميزة المضافة جديد</h5>
            </div>
            <div>
                <button className='flex items-center border border-[#62D0B6] text-[#62D0B6] rounded pb-3 pt-2 px-4'>عرض الكل <span className= "mr-2"> <Image className={Styles.leftArrowIcon} src={leftArrow} alt='#' width={0} height={0} /> </span></button>
            </div>
        </div>
